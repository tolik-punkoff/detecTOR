...
namespace DetecTOR
{
    public class IPGeoinfo
    {
        ...
        private void AddToFull(Dictionary<string, object> Add)
        {
        ...
        public void PrepareBatch()
        {
            ...
            Dictionary <string,Type>.KeyCollection AnswerKeys = 
                db.GetAllAnswerTypes(InfoType).Keys;

            foreach (string Key in AnswerKeys)
            {
                Answer.Add(Key, string.Empty);
            }

            Answer.Add("status", string.Empty);
